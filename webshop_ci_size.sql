...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 29, 2023 at 11:12 AM
...
(2, 1, 16, '2023-09-27 13:45:39', 15, 0, 'Đen', 'M'),
(3, 1, 16, '2023-09-27 13:46:09', 15, 0, 'Đỏ', 'XXL'),
(4, 1, 16, '2023-09-27 13:48:06', 25, 15, 'Đỏ', 'XXL'),
(5, 1, 17, '2023-09-28 09:01:15', 1, 150, 'Vàng', 'XXL'),
(6, 1, 16, '2023-09-29 11:56:05', 5, 15, 'Đen', 'M');
...
(7, 'GIAM200K', '2023-09-29', '2023-09-30', 10000, 3, 10, 1);
...
--
ALTER TABLE `chitietdonhang`
  MODIFY `MaChiTietDonHang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `kichthuoc`
  MODIFY `MaKichThuoc` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `lichsuxem`
  MODIFY `MaLichSuXem` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=247;
...
--
ALTER TABLE `mausac`
  MODIFY `MaMauSac` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;
