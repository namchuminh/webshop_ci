                                ...
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="simpleinput" class="form-control tensanpham" placeholder="Tên chuyên mục" required name="tenchuyenmuc">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="duongdan" class="form-control" placeholder="Đường dẫn chuyên mục.." required name="duongdan">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <br> 
                                            <img id="anhchinhload" style="width: 270px; height: 320px;">    
                                        </div>

                                        <button type="submit" class="btn btn-primary waves-effect waves-light">Thêm Chuyên Mục</button>
                                    </form>
                                </div>
                                <!-- end card-body-->
                            </div>
