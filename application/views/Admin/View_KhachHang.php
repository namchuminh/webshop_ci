                                        ...
                                        <tbody>
                                    		...
                                    		<tr role="row" class="odd">
                                                ...
                                                <?php if ($value['TrangThai'] == 1) { ?>
                                                    <td style="text-align: center;"><a href="<?php echo base_url('admin/khach-hang/them-thung-rac/'.$value['MaKhachHang'].'/'); ?>"><i style="font-size: 18px; color: #393f4e;" class="bx bx-lock"></i></a></td>
                                                <?php }else{ ?>
                                                    <td style="text-align: center;"><a href="<?php echo base_url('admin/khach-hang/mo-khoa/'.$value['MaKhachHang'].'/'); ?>"><i style="font-size: 18px; color: #393f4e;" class="bx bx-lock-open"></i></a></td>
                                                <?php } ?>
	                                        </tr>
                                    	<?php endforeach ?>
                                        </tbody>
