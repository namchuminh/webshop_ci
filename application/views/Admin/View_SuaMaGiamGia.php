                                ...
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="simpleinput" class="form-control tensanpham" placeholder="Mã sử dụng trên website..." required name="masudung" value="<?php echo $detail[0]['MaSuDung']; ?>" disabled>
                                        </div>

                                        <div class="form-group">
                                            <label for="trigia">Trị Giá (VNĐ)</label>
                                            <input type="text" id="trigia" class="form-control" placeholder="Ví dụ: 100000" required name="trigia" value="<?php echo $detail[0]['TriGia']; ?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="solandung">Số Lần Dùng</label>
                                            <input type="number" min="1" id="solandung" class="form-control" placeholder="Số lần sử dụng tối đa..." required name="soluong" value="<?php echo $detail[0]['SoLuong']; ?>">
                                        </div>

                                        <div class="form-group">
                                            <label for="hsd">Ngày Hết Hạn</label>
                                            <input type="date" id="hsd" class="form-control" placeholder="Hạn sử dụng.." required name="ngayhethan" value="<?php echo $detail[0]['NgayHetHan']; ?>">
                                        </div>

                                        <button type="submit" class="btn btn-primary waves-effect waves-light">Cập Nhật Mã Giảm Giá</button>
                                    </form>
                                </div>
                                <!-- end card-body-->
                            </div>
